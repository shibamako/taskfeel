...
class PrioritiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create priority" do
    assert_difference('Priority.count') do
      post priorities_url, params: { priority: { mukou: @priority.mukou, priority_item: @priority.priority_item, serialize: @priority.serialize } }
    end
  ...
  test "should update priority" do
    patch priority_url(@priority), params: { priority: { mukou: @priority.mukou, priority_item: @priority.priority_item, serialize: @priority.serialize } }
